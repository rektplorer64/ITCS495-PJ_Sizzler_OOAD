...
SELECT "SaladBarRefill"."employeeId", "FoodItemRef"."nameTha", "SaladBarRefill"."quantity", "QuantityUnitRef"."name"
FROM "FoodItemRef"
...
-- 32: List all payment transaction that are ever made by any customer in any billing.
