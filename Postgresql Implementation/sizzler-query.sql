...
-- B12 <4>: List the worth of each gift voucher in each gift voucher transaction.
...
-- B16 <6>: Show the availability time range of all seasonal menu.
SELECT "MR"."menuRefId",
       "MR"."nameEng",
       "SR"."name" "seasonName",
       "SR"."dateStart",
...
-- B9 <9>: List the details of all "western" food servings.
SELECT "servingRefId", "nameEng", "nameTha", "basePrice"
FROM "ServingRef"
WHERE "genre" = 'western';

-- B10 <10>: List the details of food items given a serving.
...
-- B15 <17>: Show the assigned work time of every employee.
SELECT "EV"."employeeId",
       "firstname",
       "surname",
       "age",
...
-- B17 <23>: Show the details of menu in each order.
...
-- B11 <24>: List the details of seasonal menus.
...
-- B15 <25>: Show employees in each branch.
...
-- B18 <27>: Show the salary of all Kitchen Managers
...
-- B13 <28>: Show all employees' address that are located in Chonburi
SELECT "E".*
FROM "Employee" "E"
